        ...
        <div class="col-md-9">
            <div class="card shadow">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <p>
                                        <img src="<?= $row->image ? base_url('images/produdct/'.$row->image) : 'https://placehold.co/50x50' ?>" alt="">
                ...
                <div class="card-footer">
                    <a href="<?= base_url('myorder/confirm/'.$order->invoice)?>" class="btn btn-success shadow">Konfirmasi Pembayaran</a>
                </div>
                <?php endif; ?>
            </div>
            <?php if(isset($order_confirm)): ?>
                ...
                <div class="col-md-4">
                    <img src="<?= $order_confirm->image ? base_url('images/transfer/'.$order_confirm->image) : 'https://placehold.co/150x200' ?>" alt="" width="250" class="img-thumbnail">
                </div>
            </div>
            <?php endif; ?>
        </div>
