        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card mb-3 shadow">
              <img src="<?= $row->image ? base_url("images/product/$row->image") : 'https://placehold.co/100x70'?>" alt="" class="card-image-top" height="300">
              <div class="card-body">
                <h5 class="card-title"><?= $row->product_title?></h5>
                <p class="card-text"><strong>Rp<?= number_format($row->price,0,',','.')?>,-</strong></p>
                <p class="card-text"><?= $row->description?></p>
                <a href="<?= base_url('shop/category/'.$row->category_slug)?>" class="badge badge-primary"><i class="fa fa-tags"></i> <?= $row->category_title ?></a>
              </div>
            ...
            <div class="card shadow mb-2">
              ...
              <div class="card-body">
                <form action="<?= base_url('shop/search')?>" method="POST">
                  <div class="input-group">
                    <input type="text" name="keyword" id="keyword" class="form-control" placeholder="Pencarian" value="<?= $this->session->userdata('keyword')?>">
                    <div class="input-group-append">
